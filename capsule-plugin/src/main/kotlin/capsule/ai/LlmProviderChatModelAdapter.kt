 ...
 * to langchain4j's [ChatModel] (capsule's consumption contract).
 *
 * Architecture (EPIC CAP-ARCH, decision S-083): koog orchestrates,
 * langchain4j executes. The future `capsule.pipeline` tasks consume
