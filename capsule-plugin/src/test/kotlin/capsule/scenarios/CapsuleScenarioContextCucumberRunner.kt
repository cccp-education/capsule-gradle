...
@SelectClasspathResource("features/capsule_scenario_context.feature")
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "capsule.scenarios")
@ConfigurationParameter(
    key = PLUGIN_PROPERTY_NAME,
    value = "pretty, html:build/reports/cucumber-scenario-context.html, json:build/reports/cucumber-scenario-context.json"
)
@ConfigurationParameter(
    key = FILTER_TAGS_PROPERTY_NAME,
    value = "@context and @scenario and not @wip and not @integration"
)
class CapsuleScenarioContextCucumberRunner